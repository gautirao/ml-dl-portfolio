...
-   Architected a local-first AI financial assistant using a **Planner-Executor** pattern to solve LLM arithmetic inaccuracies, achieving 100% numerical precision.
