...
def keyword_index() -> BM25KeywordIndex:
    ...
    chunks = [
        Chunk(
            ...
            chunk_index=1, text="The monthly fee for this account is £5.", 
            character_start=0, character_end=38, chunk_hash="h1"
        ),
        Chunk(
            chunk_id="c2", source_id="s1", citation_label="L1", title="T1",
            document_type=DocumentType.TERMS_CONDITIONS, product_area=ProductArea.CURRENT_ACCOUNTS,
            chunk_index=2, text="You can apply for an overdraft online.", 
            character_start=39, character_end=76, chunk_hash="h2"
        ),
        Chunk(
            ...
            chunk_index=1, text="Savings accounts do not have overdrafts.", 
            character_start=0, character_end=39, chunk_hash="h3"
        ),
        Chunk(
            chunk_id="c_extra1", source_id="s3", citation_label="L3", title="T3",
            document_type=DocumentType.PRIVACY_POLICY, product_area=ProductArea.CREDIT_CARDS,
            chunk_index=1, text="This is a privacy policy about data protection.", 
            character_start=0, character_end=47, chunk_hash="he1"
        ),
        Chunk(
            chunk_id="c_extra2", source_id="s4", citation_label="L4", title="T4",
            document_type=DocumentType.DEPOSIT_PROTECTION, product_area=ProductArea.SAVINGS,
            chunk_index=1, text="Your deposits are protected by FSCS scheme.", 
            character_start=0, character_end=43, chunk_hash="he2"
        ),
    ]
...
def test_ranking_relevance(keyword_index: BM25KeywordIndex) -> None:
    ...
    more_chunks = [
        Chunk(
            chunk_id="c4", source_id="s1", citation_label="L1", title="T1",
            document_type=DocumentType.TERMS_CONDITIONS, product_area=ProductArea.CURRENT_ACCOUNTS,
            chunk_index=4, text="fee fee fee fee", 
            character_start=0, character_end=15, chunk_hash="h4"
        )
    ]
