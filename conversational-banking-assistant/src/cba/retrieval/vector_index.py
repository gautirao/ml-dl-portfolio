...
class QdrantVectorIndex:
    ...
    def __init__(
        self, embedding_model: EmbeddingModel, location: str | None = None, path: str | None = None
    ) -> None:
        """
    ...
    def add_chunks(self, chunks: list[Chunk]) -> None:
        ...
        for chunk, vector in zip(chunks, embeddings, strict=True):
            ...
            points.append(PointStruct(id=point_id, vector=vector, payload=chunk.model_dump()))
